...
namespace Capstone1.Server.Migrations
{
    ...
    [Migration("20220418124122_Interest_Language_User_Admin")]
    partial class Interest_Language_User_Admin
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Capstone1.Shared.Chat", b =>
                {
                    b.HasOne("Capstone1.Shared.User", "Recipient")
                        .WithMany()
                        .HasForeignKey("RecipientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Capstone1.Shared.User", "Sender")
                        .WithMany()
